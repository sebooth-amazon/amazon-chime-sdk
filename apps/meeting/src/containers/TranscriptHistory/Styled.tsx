...
export const StyledTranscript = styled.aside<any>`
  display: grid;
...
export const StyledTranscriptInputContainer = styled.div`
  grid-area: transcript-input;
  display: flex;
  align-items: center;
